  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* When idle/empty, show the recent-recordings dashboard; during a live
            recording (or transcript processing) show the streaming transcript. */}
        ...
        {/* During a live recording, keep pause/stop controls available. The idle
            Home page intentionally has no large record button: recordings can
            start from the tray menu or automatic meeting detection. */}
        {isRecording &&
          status !== RecordingStatus.PROCESSING_TRANSCRIPTS &&
          status !== RecordingStatus.SAVING && (
                ...
                <div className="w-2/3 max-w-[750px] flex justify-center">
                  <div className="bg-white rounded-full shadow-lg flex items-center">
                    <RecordingControls
                      ...
                      onMeetingNameChange={setMeetingTitle}
                    />
                  </div>
                </div>
              </div>
